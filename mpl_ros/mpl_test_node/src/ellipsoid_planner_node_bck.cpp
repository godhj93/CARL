...
{
  res.result_traj = planning_ros_msgs::Trajectory();
  return true;
}
int main(int argc, char **argv) {
  ...
  ros::NodeHandle nh("~");
  //gs added
  ros::ServiceServer service = nh.advertiseService("trajectory_generation_service", test);
  ...
  sensor_msgs::PointCloud2 tmp =
      read_bag<sensor_msgs::PointCloud2>(file_name, topic_name, 0).back();               
